...
#data = json.loads(open('./datasets/railway_semantic_segmentation.json', "r").read())
data = json.loads(open('./datasets/railways_night_semseg_100.json', "r").read())
...
for image_info in data['images']:
    ...
    output_folder = './datasets/railway_night_semseg_5classes_json_polygons'
