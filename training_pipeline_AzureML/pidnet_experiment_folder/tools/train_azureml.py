...
def main():
    ...
    print("Loading Data...")
    training_data = run.input_datasets['railways_daynight_semseg_5classes_dataset']
    print("Data Loaded!")
    ...
    model = run.register_model(model_name=f"railways_daynight_SemSegm_5classes_{config.MODEL.NAME}",
                               ...
                               datasets=[('railways_daynight_semseg_5classes_dataset', training_ds)],
